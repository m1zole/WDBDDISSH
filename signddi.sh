#!/bin/sh
openssl dgst -sign key.pem -out DeveloperDiskImageModified_16.6.dmg.signature -binary -sha1 DeveloperDiskImageModified_16.6.dmg
...
openssl dgst -sign key.pem -out DeveloperDiskImageModified_15.7.dmg.signature -binary -sha1 DeveloperDiskImageModified_15.7.dmg
